...
export default function AuthenticationLayout() {
  ...
  return (
    <div className="flex h-screen bg-[var(--mantine-color-gray-3)] p-0 md:p-6">
      <div className="h-full max-h-full flex overflow-hidden rounded-2xl bg-white shadow-sm">
        <Sidebar />
      </div>
      <div className="h-full max-h-full flex flex-col overflow-hidden w-full items-center md:rounded-2xl">
